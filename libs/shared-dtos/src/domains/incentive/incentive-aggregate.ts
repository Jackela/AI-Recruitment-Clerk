/**
 * Incentive aggregate root.
 * Manages the core business logic for the incentive (红包) system.
 */

import type { DomainEvent } from '../../base/domain-event';
import type { PaymentMethod } from './incentive-enums';
import { IncentiveStatus } from './incentive-enums';
import type { IncentiveData } from './incentive-interfaces';
import type {
  ContactInfo} from './incentive-value-objects';
import {
  IncentiveId,
  IncentiveRecipient,
  IncentiveReward,
...
import { IncentiveValidationResult, PaymentResult, IncentiveSummary } from './incentive-results';
import {
