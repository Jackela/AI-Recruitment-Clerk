...
exports.ContractTestUtils = exports.ContractValidators = exports.ContractViolationError = void 0;
    ...
    return function (target, propertyKey, descriptor) {
        ...
        descriptor.value = async function (...args) {
            if (!condition.apply(this, args)) {
                throw new ContractViolationError(message, 'PRE', `${target.constructor.name}.${propertyKey}`);
            }
...
function Ensures(condition, message) {
    return function (target, propertyKey, descriptor) {
        ...
        descriptor.value = async function (...args) {
            ...
            if (!condition(result)) {
                throw new ContractViolationError(message, 'POST', `${target.constructor.name}.${propertyKey}`);
            }
            return result;
        };
        return descriptor;
...
(function (ContractValidators) {
    ...
    ContractValidators.isValidEmail = isValidEmail;
    /**
    ...
    ContractValidators.isNonEmptyString = isNonEmptyString;
    /**
    ...
    ContractValidators.isValidFileSize = isValidFileSize;
    /**
    ...
    ContractValidators.isPdfFile = isPdfFile;
    /**
    ...
    ContractValidators.hasElements = hasElements;
    /**
    ...
    ContractValidators.isValidJD = isValidJD;
    /**
    ...
    ContractValidators.isValidResume = isValidResume;
    /**
     ...
     * @since 1.0.0
     */
    function isValidScoreRange(score) {
        return typeof score === 'number' && score >= 0 && score <= 100;
    }
    ContractValidators.isValidScoreRange = isValidScoreRange;
    /**
     ...
     * @since 1.0.0
     */
    function isValidScoreDTO(scoreDto) {
        return !!(scoreDto &&
    ...
    ContractValidators.isValidScoreDTO = isValidScoreDTO;
    /**
     ...
     * @since 1.0.0
     */
    function isValidExperienceRange(experienceYears) {
    ...
    ContractValidators.isValidExperienceRange = isValidExperienceRange;
    /**
     ...
     * @since 1.0.0
     */
    function isValidCandidateInfo(candidateInfo) {
    ...
    ContractValidators.isValidCandidateInfo = isValidCandidateInfo;
    /**
     ...
     * @since 1.0.0
     */
    function isValidReportResult(reportResult) {
        return !!(reportResult &&
    ...
    ContractValidators.isValidReportResult = isValidReportResult;
    /**
     ...
     * @since 1.0.0
     */
    function isValidJobInfo(jobInfo) {
        return !!(jobInfo &&
    ...
    ContractValidators.isValidJobInfo = isValidJobInfo;
    /**
     ...
     * @since 1.0.0
     */
    function isValidExtractionResult(extractionResult) {
    ...
    ContractValidators.isValidExtractionResult = isValidExtractionResult;
    /**
     ...
     * @since 1.0.0
     */
    function isValidProcessingTime(processingTime, maxTime = 30000) {
        return typeof processingTime === 'number' &&
            processingTime > 0 &&
            processingTime <= maxTime;
    }
    ContractValidators.isValidProcessingTime = isValidProcessingTime;
    /**
     ...
     * @since 1.0.0
     */
    function isValidConfidenceLevel(confidence) {
        return typeof confidence === 'number' &&
            confidence >= 0.0 &&
            confidence <= 1.0;
    }
    ContractValidators.isValidConfidenceLevel = isValidConfidenceLevel;
})(ContractValidators || (exports.ContractValidators = ContractValidators = {}));
/**
...
(function (ContractTestUtils) {
     ...
     * @since 1.0.0
     */
    function expectContractViolation(fn, expectedType, expectedMessage) {
        let error = null;
        try {
            fn();
        }
    ...
    ContractTestUtils.expectContractViolation = expectContractViolation;
    /**
     ...
     * @since 1.0.0
     */
    async function expectAsyncContractViolation(fn, expectedType, expectedMessage) {
        let error = null;
        try {
            await fn();
        }
    ...
    ContractTestUtils.expectAsyncContractViolation = expectAsyncContractViolation;
})(ContractTestUtils || (exports.ContractTestUtils = ContractTestUtils = {}));
