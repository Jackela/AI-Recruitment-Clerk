import { IncentiveRejectedEvent } from './incentive-rejected.event';

describe('IncentiveRejectedEvent', () => {
  const createEvent = (
    overrides?: Partial<{
      incentiveId: string;
      recipientIP: string;
  ...
  describe('constructor', () => {
    ...
    it('should create event with default values', () => {
      ...
      expect(event.reason).toBe('Invalid data');
    });
  });
