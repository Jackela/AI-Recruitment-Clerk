import { Component, EventEmitter, Output, ViewChild, ElementRef, signal, Input } from '@angular/core';
...
export class ResumeFileUploadComponent {
  ...
  private handleFileSelection(file: File): void {
    ...
    if (!allowedTypes.includes(file.type)) {
      this.fileValidationError.emit('不支持的文件格式。请上传 PDF、DOC 或 DOCX 文件。');
      return;
    }
