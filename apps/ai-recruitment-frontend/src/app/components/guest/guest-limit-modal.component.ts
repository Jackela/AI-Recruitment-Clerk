      ...
      <div class="bg-white rounded-lg p-6 max-w-md mx-4 relative">
        ...
        <div class="text-center">
          ...
          <p class="text-gray-600 mb-4">
            您已经使用完了 <span class="font-semibold">5次</span> 免费简历分析次数。
          </p>
          ...
          <div class="bg-gradient-to-r from-blue-50 to-indigo-50 p-4 rounded-lg mb-6">
            ...
            <p class="text-sm text-gray-700">
              参与问卷反馈可再获 <span class="font-semibold text-blue-600">5次使用权</span>！
            </p>
          </div>

          <!-- Usage stats -->
          <div class="text-sm text-gray-500 mb-6" *ngIf="guestState$ | async as state">
            <div class="flex justify-between items-center py-1">
              <span>已使用:</span>
              <span class="font-medium">{{ state.usageCount }}/{{ state.maxUsage }}</span>
            </div>
            <div class="flex justify-between items-center py-1">
              <span>剩余次数:</span>
              <span class="font-medium text-orange-600">{{ state.remainingCount }}</span>
            </div>
          </div>
