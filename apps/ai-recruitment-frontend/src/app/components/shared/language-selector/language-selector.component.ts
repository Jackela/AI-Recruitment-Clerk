      ...
      <div class="language-dropdown" 
        ...
        <button 
          *ngFor="let lang of availableLanguages"
          ...
          <svg *ngIf="lang.code === currentLanguage()" class="check-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
export class LanguageSelectorComponent {
  ...
  currentLanguageConfig = computed(() => this.i18nService.getCurrentLanguageConfig());
