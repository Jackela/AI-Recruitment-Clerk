        ...
        <form [formGroup]="reactiveForm" (ngSubmit)="onReactiveSubmit()">
          <div class="form-group">
            ...
            <input 
              ...
              class="form-control"
              [class.error]="reactiveForm.get('company')?.invalid && reactiveForm.get('company')?.touched"
              [class.success]="reactiveForm.get('company')?.valid && reactiveForm.get('company')?.touched"
            />
            <arc-validation-feedback 
          ...
          <div class="form-group">
            ...
            <input 
              ...
              class="form-control"
              [class.error]="reactiveForm.get('position')?.invalid && reactiveForm.get('position')?.touched"
              [class.success]="reactiveForm.get('position')?.valid && reactiveForm.get('position')?.touched"
            />
            <arc-validation-feedback 
          ...
          <div class="form-group">
            ...
            <input 
              ...
              class="form-control"
              [class.error]="reactiveForm.get('salary')?.invalid && reactiveForm.get('salary')?.touched"
              [class.success]="reactiveForm.get('salary')?.valid && reactiveForm.get('salary')?.touched"
            />
            <arc-validation-feedback 
