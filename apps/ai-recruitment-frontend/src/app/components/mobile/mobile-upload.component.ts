    ...
    <div class="mobile-upload-container">
      ...
      <div 
        ...
        <div class="upload-content">
          ...
          <h4 class="upload-text">{{ isDragOver ? 'Drop files here' : 'Tap to upload or drag files' }}</h4>
          <p class="upload-hint">{{ allowedTypes.join(', ') }} files up to {{ maxSizeMB }}MB</p>
            ...
            <div class="file-info">
              ...
              <div class="file-details">
                ...
                <span class="file-status" [ngSwitch]="file.status">
                  ...
                  <span *ngSwitchCase="'success'" class="status success">Complete</span>
                  <span *ngSwitchCase="'error'" class="status error">{{ file.error || 'Error' }}</span>
                </span>
              </div>
      ...
      <div class="upload-summary" *ngIf="files.length > 0">
        ...
        <button 
          ...
          *ngIf="canSubmit"
          ...
          type="button">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" *ngIf="!hasUploading">
...
export class MobileUploadComponent implements OnInit, OnDestroy {
  ...
  get canSubmit(): boolean {
    return this.files.length > 0 && this.files.some(file => file.status === 'pending' || file.status === 'error');
  }
