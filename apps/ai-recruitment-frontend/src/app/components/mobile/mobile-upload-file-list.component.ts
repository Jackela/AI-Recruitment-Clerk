...
/**
 * Represents the mobile upload file list component.
 * Displays a list of uploaded files with status, progress, and actions.
 */
@Component({
  selector: 'arc-mobile-upload-file-list',
  standalone: true,
...
export class MobileUploadFileListComponent {
  ...
  @Output()
  public remove = new EventEmitter<UploadFile>();

  @Output()
  public retry = new EventEmitter<UploadFile>();
