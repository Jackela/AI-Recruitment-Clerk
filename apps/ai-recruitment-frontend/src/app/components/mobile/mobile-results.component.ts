    ...
    <div class="mobile-results-container">
      ...
      <div class="results-header">
        ...
        <div class="header-actions">
          ...
          <button 
            ...
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
              <path [attr.d]="viewMode === 'card' ? 'M3,5V19H21V5H3M5,7H19V17H5V7Z' : 'M3,5H21V7H3V5M3,13V11H21V13H3M3,17V19H21V17H3Z'"/>
            </svg>
          </button>
        </div>
      </div>
        ...
        <div class="sort-options">
          <button 
            *ngFor="let option of sortOptions"
            ...
            <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" *ngIf="currentSort === option.value">
      ...
      <div class="results-summary" *ngIf="filteredResults.length > 0">
        <div class="summary-info">
          <span class="results-count">{{ filteredResults.length }} candidates</span>
          <span class="match-summary" *ngIf="getMatchSummary()">{{ getMatchSummary() }}</span>
        </div>
          ...
          <app-mobile-swipe
            ...
            <div 
              ...
              <div class="candidate-avatar">
                ...
                <div class="status-indicator" [class]="'status-' + candidate.status"></div>
              </div>
              ...
              <div class="candidate-info">
                ...
                <div class="candidate-experience">{{ candidate.experience }} • {{ candidate.location }}</div>
                
                <!-- Skills Tags -->
                <div class="skills-container" *ngIf="candidate.skills.length > 0">
                  <span 
                  ...
                  <span 
                    *ngIf="candidate.skills.length > 3"
                    class="skill-more">
              ...
              <!-- Quick Actions -->
              <div class="quick-actions-menu" *ngIf="showQuickActions && selectedCandidate?.id === candidate.id">
                <button 
      ...
      <div class="empty-state" *ngIf="filteredResults.length === 0 && !isLoading">
        <div class="empty-icon">
          <svg width="64" height="64" viewBox="0 0 24 24" fill="currentColor">
            <path d="M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22A10,10 0 0,1 2,12A10,10 0 0,1 12,2M12,4A8,8 0 0,0 4,12A8,8 0 0,0 12,20A8,8 0 0,0 20,12A8,8 0 0,0 12,4M13,9H11V7H13M13,17H11V11H13V17Z"/>
          </svg>
        </div>
...
export class MobileResultsComponent implements OnInit, OnDestroy {
  ...
  @Output() bulkActionTriggered = new EventEmitter<{action: string, candidates: CandidateResult[]}>();
  ...
  getMatchSummary(): string {
    ...
    const excellent = this.filteredResults.filter(c => c.match === 'excellent').length;
