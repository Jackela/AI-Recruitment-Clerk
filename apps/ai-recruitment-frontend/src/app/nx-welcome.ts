      ...
      <div class="container">
        ...
        <div id="welcome">
          <h1>
            ...
            Welcome ai-recruitment-frontend 👋
          </h1>
        </div>
        <!--  HERO  -->
        ...
        <div id="commands" class="rounded shadow">
          ...
          <details>
            ...
            <pre><span># Build</span>
nx build ai-recruitment-frontend
<span># Test</span>
nx test ai-recruitment-frontend
<span># Lint</span>
nx lint ai-recruitment-frontend
<span># Run them together!</span>
nx run-many -p ai-recruitment-frontend -t build test lint</pre>
          </details>
          <details>
            <summary>
              <svg
            ...
            <pre>nx show project ai-recruitment-frontend</pre>
          </details>
