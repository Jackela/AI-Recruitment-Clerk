/**
 * Tests for ExperienceCalculator - Basic functionality
 *
 * This file contains basic tests for experience calculation:
 * - Single position tests
 * - Multiple positions tests
 * - Empty/invalid input tests
 * - Month/year conversion tests
 * - Edge cases for calculateTotalExperience
 */
...
describe('ExperienceCalculator - Basic Tests', () => {
