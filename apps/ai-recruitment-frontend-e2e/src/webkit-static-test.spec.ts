...
test.describe('WebKit Static Build Tests', () => {
  ...
  test('WebKit works with static production build', async ({ page, browserName }) => {
  ...
  test('WebKit JavaScript execution works with static build', async ({ page, browserName }) => {
    test.skip(browserName !== 'webkit', 'This test is WebKit-specific');
  ...
  test('WebKit navigation works with static build', async ({ page, browserName }) => {
    test.skip(browserName !== 'webkit', 'This test is WebKit-specific');
  ...
  test('WebKit handles multiple page loads with static build', async ({ page, browserName }) => {
    test.skip(browserName !== 'webkit', 'This test is WebKit-specific');
