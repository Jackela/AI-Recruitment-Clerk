 ...
 */
export const createMockJobJdSubmittedEvent = (overrides?: Partial<JobJdSubmittedEvent>): JobJdSubmittedEvent => ({
  jobId: 'job-uuid-123',
 ...
 */
export const createMockAnalysisJdExtractedEvent = (overrides?: Partial<AnalysisJdExtractedEvent>): AnalysisJdExtractedEvent => ({
  jobId: 'job-uuid-123',
 ...
 */
export const createMockExtractedJdDTO = (overrides?: Partial<JdDTO>): JdDTO => ({
  requirements: {
    technical: [
      'JavaScript',
      'TypeScript', 
 ...
 */
export const createMockLlmExtractionRequest = (overrides?: Partial<LlmExtractionRequest>): LlmExtractionRequest => ({
  jobTitle: 'Senior Full Stack Developer',
 ...
 */
export const createMockLlmExtractionResponse = (overrides?: Partial<LlmExtractionResponse>): LlmExtractionResponse => ({
  extractedData: createMockExtractedJdDTO(),
  confidence: 0.85,
 ...
 */
export const createMockLowConfidenceLlmResponse = (overrides?: Partial<LlmExtractionResponse>): LlmExtractionResponse => ({
 ...
 */
export const createMockNatsPublishResult = (success = true, messageId?: string, error?: string): NatsPublishResult => ({
  success,
 ...
 */
export const createMockNatsSuccessResult = (messageId?: string): NatsPublishResult => 
  createMockNatsPublishResult(true, messageId);

/**
 * Mock factory for failed NATS publish result
 */
export const createMockNatsFailureResult = (error = 'Connection timeout'): NatsPublishResult => 
  createMockNatsPublishResult(false, undefined, error);
...
export const isValidJobJdSubmittedEvent = (event: any): event is JobJdSubmittedEvent => {
  return event &&
...
export const isValidAnalysisJdExtractedEvent = (event: any): event is AnalysisJdExtractedEvent => {
  return event &&
    typeof event.jobId === 'string' &&
    event.extractedData &&
...
export const isValidLlmExtractionRequest = (request: any): request is LlmExtractionRequest => {
  return request &&
...
export const isValidLlmExtractionResponse = (response: any): response is LlmExtractionResponse => {
  return response &&
...
export const isValidNatsPublishResult = (result: any): result is NatsPublishResult => {
  return result &&
...
export const validateJobJdSubmittedEvent = (event: any): void => {
  if (typeof expect === 'undefined') {
    throw new Error('This validation helper can only be used in Jest test environment');
  }
 ...
 */
export const createMultipleJobEvents = (count: number): JobJdSubmittedEvent[] => {
...
export const createMultipleAnalysisEvents = (count: number): AnalysisJdExtractedEvent[] => {
  return Array.from({ length: count }, (_, index) => 
